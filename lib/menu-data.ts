...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    description:
      'Guyanese curry — deeper and more layered than Jamaican style. The roti is rolled to order, every time. Also available with rice and peas.',
    price: 17,
    category: 'plates',
    tags: ['halal'],
  ...
  },
  {
    ...
    description:
      'The same rich Guyanese curry base, fully plant-based. Not a compromise — a complete, satisfying dish. Also available with rice and peas.',
    price: 16,
    category: 'plates',
    tags: ['vegan', 'halal'],
    image: '/images/dish-curry-roti.jpg',
  ...
  },
  {
    id: 'turkey-patty',
    name: 'Turkey Patty',
    description: 'Seasoned ground turkey in the same buttery house-made pastry shell.',
    price: 5,
    category: 'patties',
    tags: ['halal'],
    image: '/images/gallery/pine-tarts.jpg',
    imageAlt: 'Caribbean turkey patty at Caribbean Gourmet San Gabriel',
  },
  {
    id: 'chicken-patty',
    name: 'Chicken Patty',
